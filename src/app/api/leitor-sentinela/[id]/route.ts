...
export async function PUT(
  ...
  try {
    ...
    // Nota: Você precisará adicionar um método update no leitorListSentinelaUtils
    // Por enquanto, vamos deletar e recriar (simplificação)
    await leitorListSentinelaUtils.delete(id);
